...
const defaultMeta = {
  title: 'BGPWESTKAL.ID',
  siteName: 'BGPWESTKAL.ID',
  description:
    'Landing page BGPWESTKAL.ID,Menghubungkan dan Memajukan Daerah Terpencil ',
  // change base url of your web (without '/' at the end)
  url: 'https://bgpwestkal.id',
  type: 'website',
  robots: 'follow, index',
  // change with url of your image (recommended dimension = 1.91:1)
  // used in twitter, facebook, etc. card when link copied in tweet/status 
  image: 'https://bgpwestkal.id/assets/card-image.png',
  author: 'A. Fauzan'
};
